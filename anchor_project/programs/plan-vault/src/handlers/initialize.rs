...
use crate::{error::InitializeErrors, state::VaultAccount};
...
pub struct InitializeVault<'info> {
    ...
    #[account(
        ...
        seeds = [b"vault", plan_title.as_bytes(), owner.key().as_ref()],
        bump
    )]
